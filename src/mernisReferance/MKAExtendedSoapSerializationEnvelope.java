...
public class MKAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MKADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MKAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MKADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MKADateTimeConverter dateTimeConverter = new MKAStandardDateTimeConverter();

    public MKAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MKAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MKAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MKAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MKAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MKAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
