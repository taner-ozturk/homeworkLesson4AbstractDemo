...
public class MKAKPSPublicSoap12
{
    ...
    public MKAKPSPublicSoap12(){}

    public MKAKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public MKAKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MKAExtendedSoapSerializationEnvelope envelope= new MKAExtendedSoapSerializationEnvelope(MKAExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,MKAExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new MKAIWcfMethod()
        {
            @Override
    ...
    protected java.lang.Object execute(MKAIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,MKAExtendedSoapSerializationEnvelope envelope)
    {
